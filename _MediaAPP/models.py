...
class TourImage(models.Model):
    ...
    image = models.ImageField(upload_to="images/tour_images", blank=True, null=True)
    caption = models.CharField(max_length=255, default="")
    is_main_image = models.BooleanField(default=False)
    image_url = models.URLField(max_length=220, null=True)
...
class StopImage(models.Model):
    ...
    sub_stop = models.ForeignKey(
        SubStop, on_delete=models.PROTECT, related_name="image", null=True, blank=True
    )
...
class StopAudio(models.Model):
    ...
    sub_stop = models.ForeignKey(
        SubStop, on_delete=models.PROTECT, related_name="audio", null=True, blank=True
    )
...
class StopVideo(models.Model):
    ...
    sub_stop = models.ForeignKey(
        SubStop, on_delete=models.PROTECT, related_name="video", null=True, blank=True
    )
